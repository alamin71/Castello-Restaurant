...
const PopularMenu = () => {
    const foodItems: FoodCardProps[] = [
        ...
        { title: "Pepperoni Pizza", description: "12\" pizza with extra cheese & pepperoni", price: 12.99, image: "/assets/pizza.png" },
        ...
        { title: "BBQ Chicken Pizza", description: "Smoky BBQ chicken with cheese", price: 13.99, image: "/assets/pizza.png" },
    ];
