...
export default function LoginModal() {
    ...
    return (
        <Dialog open={isLoginModalOpen} onOpenChange={(open) => { if (!open) handleClose(); }}>
                ...
                {step === "phone" ? (
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-white/50 mt-1">Log in to start ordering</p>
                        </div>
                            ...
                            <div className="flex items-stretch gap-0 rounded-xl border border-white/20 overflow-hidden bg-white/5">
                                <Select value={countryCode} onValueChange={setCountryCode}>
                                    ...
                                    <SelectContent className="bg-[#1c1c1e] border border-white/20 text-white">
                                        {COUNTRIES.map((c) => (
                                            <SelectItem key={c.code} value={c.code} className="text-white focus:bg-white/10 focus:text-white cursor-pointer">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        {/* OTP boxes */}
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-semibold text-white">Verification code</label>
